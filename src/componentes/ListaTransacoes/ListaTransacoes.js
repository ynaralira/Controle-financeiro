...
function ListaTransacoes({ insercaoFeita, termoBusca, atualizarTotalSaidas }) {
    ...
    const registrarPagamento = async (index) => {
        try {
            ...
            const response = await fetch("http://localhost/php/registrar_pagamento.php", {
                method: 'POST',
                headers: {
    ...
    const excluirEntradaCorrespondente = async (valorTransacao) => {
        try {
            const response = await fetch("http://localhost/php/excluir_entrada_correspondente.php", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const excluirTransacao = async (index, tipoTransacao) => {
        try {
            const transacao = transacoes[index];
            const response = await fetch("http://localhost/php/excluir_transacao.php", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const fetchData = async () => {
        try {
            const response = await fetch("http://localhost/php/lista_transacoes.php", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
